...
ax_lower.tick_params(axis="both", labelsize=18)
ax_lower.set_ylabel(r"Magnetic field strength [$\mu T$]", fontsize=20)
ax_lower.set_xlabel(r"Hours [$CET$]", fontsize=20)
...
ax_upper.set_ylabel(r"$T_B$ (Normalized)", fontsize=20)
